"""
Module: strategy_gautam_trading_strategy.py
...
strategy_gautam_trading_strategy = strategy_gautam_jha_pdh_pdl_breakout_reversal

__all__ = ["strategy_gautam_jha_pdh_pdl_breakout_reversal", "strategy_gautam_trading_strategy"]
