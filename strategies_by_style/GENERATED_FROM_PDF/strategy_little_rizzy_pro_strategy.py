"""
Module: strategy_little_rizzy_pro_strategy.py
...
strategy_little_rizzy_pro_strategy = strategy_little_rizzy_trend_bos

__all__ = ["strategy_little_rizzy_trend_bos", "strategy_little_rizzy_pro_strategy"]
