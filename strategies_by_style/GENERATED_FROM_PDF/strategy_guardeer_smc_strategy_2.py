"""
Module: strategy_guardeer_smc_strategy_2.py
...
strategy_guardeer_smc_strategy_2 = strategy_guardeer_smc_structure_bos_ob

__all__ = ["strategy_guardeer_smc_structure_bos_ob", "strategy_guardeer_smc_strategy_2"]
