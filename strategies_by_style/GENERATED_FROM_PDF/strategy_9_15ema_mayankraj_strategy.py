...
def strategy_9_15ema_mayankraj_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    9 15EMA MAYANKRAJ STRATEGY
    ...
    Stop Loss:
      - . Risk Management: Always use stop loss above resistance (sell) or below support (buy).
    
    Take Profit:
      - . Target: Set the next support (for sell) or resistance (for buy) as your target.
...
if __name__ == "__main__":
    ...
    # signals = 9_15ema_mayankraj_strategy(df)
    pass
