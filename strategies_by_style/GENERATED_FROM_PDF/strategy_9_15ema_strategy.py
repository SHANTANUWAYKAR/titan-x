...
def strategy_9_15ema_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    9 15EMA STRATEGY
    ...
    Stop Loss:
      - Stop-loss: Below the low of the bullish signal candle.
    
    Take Profit:
      - Target: Maintain a **1:2 Risk-Reward Ratio**.
