...
Category: INDIA_STOCK | Volatility: low
"""
...
def strategy_intraday_itc(df: pd.DataFrame) -> pd.Series:
    """
    WORLD-CLASS INTRADAY STRATEGY FOR ITC
