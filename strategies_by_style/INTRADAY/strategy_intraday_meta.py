...
Category: US_STOCK | Volatility: high
"""
...
def strategy_intraday_meta(df: pd.DataFrame) -> pd.Series:
    """
    WORLD-CLASS INTRADAY STRATEGY FOR META
