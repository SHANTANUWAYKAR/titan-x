...
✓ Entry Threshold: 65/100 confluence

Category: BOND | Trend Strength: ADX > 20
"""
...
def strategy_swing_us10y(df: pd.DataFrame) -> pd.Series:
    """
    WORLD-CLASS SWING STRATEGY FOR US10Y
