...
One extraction, 16 instruments, only the cut depth varies. The paper cuts ~1,000 names to 20 (2%); the hardest cut available here is 1 of 16.

| Top-N | % of universe | Trades | Win% gross | Gross R | Break-even cost |
|---|---|---|---|---|---|
| 1 | 6% | 4,313 | 18.53% | -0.0727 | -2.32 bps |
| 3 | 19% | 6,748 | 20.39% | -0.0694 | -2.38 bps |
| 8 | 50% | 7,225 | 21.15% | -0.0658 | -2.31 bps |
| 16 | 100% | 7,235 | 21.16% | -0.0659 | -2.31 bps |

**Monotone in the claimed direction: NO** (gross R improving as the cut hardens). Without monotonicity the two or three favourable points are consistent with sampling variation rather than a dose-response.
...
|---|---|---|---|---|---|
| _(no filter)_ | 19,663 | 100% | 17.18% | -0.1398 | -4.48 bps |
| 0x | 19,476 | 99% | 17.12% | -0.1401 | -4.48 bps |
| 0.25x | 13,536 | 69% | 20.34% | -0.0575 | -1.93 bps |
| 0.5x | 12,326 | 63% | 20.79% | -0.0573 | -1.95 bps |
| 0.75x | 10,375 | 53% | 21.24% | -0.0708 | -2.47 bps |
| 1x | 7,235 | 37% | 21.16% | -0.0659 | -2.31 bps |
| 1.25x | 4,335 | 22% | 21.18% | -0.0127 | -0.43 bps |
| 1.5x | 3,121 | 16% | 19.77% | -0.0253 | -0.85 bps |
| 2x | 2,096 | 11% | 18.27% | -0.0361 | -1.18 bps |
| 3x | 1,336 | 7% | 16.99% | -0.0375 | -1.20 bps |
| 4x | 967 | 5% | 17.68% | -0.0001 | -0.00 bps |
| 6x | 591 | 3% | 16.24% | -0.0568 | -1.83 bps |

**Monotone as the threshold rises: NO.** The curve is not ordered, so the favourable points are consistent with sampling variation. Note the trade count collapses as the threshold rises -- a thinner sample is a noisier estimate, not a better one.
