...
**Edge under test:** CLAIMED edge: 31.9% win rate at 2.0R, cost 0.0000 R/trade -- not measured on this book

Win rate **31.94%** · reward:risk **2.00** · expectancy **-0.0418 R** · pool 20,000 trades.

Intended risk **10.00%** of balance per trade · instrument **mnq** · minimum ticket risk **$20.00** · 4,000 simulations per rung · at most 2,000 trades per path.

**Kelly fraction at this edge: -2.09%.** Negative, which means the size that loses least is zero -- every rung below is a measurement of how fast the account dies, not of how it grows.
...
| $100 to $1,000 | 10x | 4.78% | 8.97% | **-4.20 pt** | 95.23% | 0.00% | 79 | $0.00 | 20.00% |
| $1,000 to $10,000 | 10x | 3.25% | 9.20% | **-5.95 pt** | 96.75% | 0.00% | 138 | $9.95 | 10.00% |
| $10,000 to $100,000 | 10x | 3.33% | 9.68% | **-6.35 pt** | 96.67% | 0.00% | 133 | $9.83 | 10.00% |
