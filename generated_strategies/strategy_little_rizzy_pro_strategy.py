...
def little_rizzy_pro_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    LITTLE RIZZY PRO STRATEGY
    ...
    Stop Loss:
      ...
      - Stop Loss: Below the nearest swing low. Target 1: Previous Higher High. If momentum remains strong, aim for a 1:3 to 1:4 Risk:Reward.
...
if __name__ == "__main__":
    ...
    # signals = little_rizzy_pro_strategy(df)
    pass
