...
def mambafx_premium_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    MAMBAFX PREMIUM STRATEGY
    ...
    Stop Loss:
      ...
      - Place your stop loss below the breakout candle for buy trades and above the breakout candle for sell trades.
    
    Take Profit:
      - Risk Reward Ratio|1:3|
      - Step 7: Follow 1:3 Risk Reward
...
if __name__ == "__main__":
    ...
    # signals = mambafx_premium_strategy(df)
    pass
