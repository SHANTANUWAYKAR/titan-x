...
def inna_rosputnia_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    Inna Rosputnia STRATEGY
    ...
    Exit:
      - Exit Rules
      - Exit the trade when price crosses below the 18 SMA and closes underneath it.
...
if __name__ == "__main__":
    ...
    # signals = inna_rosputnia_strategy(df)
    pass
