...
def jadecap_trading_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    JADECAP TRADING STRATEGY
    ...
    Stop Loss:
      - •Open the 1 Hour timeframe chart. •For SHORT trades: Mark the previous swing high. •For LONG trades: Mark the previous swing low. •These levels usually contain retail traders’ stop losses.
      - •Allow the market to break above the previous swing high for shorts. •Or allow the market to break below the previous swing low for longs. •This movement sweeps liquidity and hits retail stop losses. •Avoid entering immediately after the breakout.
    
    Take Profit:
      - Step 7 – Target Placement
      - •Use the nearest support zone as target for SHORT trades. •Use the nearest resistance zone as target for LONG trades. •Maintain at least a 1:2 Risk Reward Ratio.
...
if __name__ == "__main__":
    ...
    # signals = jadecap_trading_strategy(df)
    pass
