...
def fare_value_gap(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    FARE VALUE GAP
    ...
    Stop Loss:
      - . Stop loss FVG ke upar/neeche rakhein.
    
    Take Profit:
      - . Target previous high/low ya next liquidity zone ho sakta hai. **Pro Tips**
