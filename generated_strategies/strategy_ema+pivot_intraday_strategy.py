...
def ema+pivot_intraday_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    EMA+Pivot Intraday Strategy
    ...
    Stop Loss:
      - Stop Loss:
      - Slightly below EMA and Pivot with a small buffer.
...
if __name__ == "__main__":
    ...
    # signals = ema+pivot_intraday_strategy(df)
    pass
