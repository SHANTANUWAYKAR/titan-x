"""
200_EMA_Trading_Strategy_Guide
...
def 200_ema_trading_strategy_guide(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    200_EMA_Trading_Strategy_Guide
...
if __name__ == "__main__":
    ...
    # signals = 200_ema_trading_strategy_guide(df)
    pass
