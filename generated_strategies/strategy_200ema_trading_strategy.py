...
def 200ema_trading_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    200EMA TRADING STRATEGY
    ...
    Stop Loss:
      ...
      - Use proper stop loss in every trade.
    
    Take Profit:
      - . Always maintain a minimum Risk:Reward ratio of **1:2**.
...
if __name__ == "__main__":
    ...
    # signals = 200ema_trading_strategy(df)
    pass
