...
def ema_rejection_strategy(df: pd.DataFrame, params: Optional[Dict] = None) -> pd.Series:
    """
    EMA REJECTION STRATEGY
    ...
    Stop Loss:
      - Set the next support (for sell) or resistance (for buy) as the target. 6Always manage risk properly using stop-loss.
...
if __name__ == "__main__":
    ...
    # signals = ema_rejection_strategy(df)
    pass
